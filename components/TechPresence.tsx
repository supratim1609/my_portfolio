  ...
  return (
    <section id="presence" className="py-32 px-6 lg:px-8 bg-[#050505]">
      <div className="max-w-5xl mx-auto">
        <div className="mb-20">
          <h2 className="text-xs font-medium tracking-widest text-[#A1A1A1] uppercase mb-6">Speaking & Community Leadership</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
          ...
          >
            <GlowingCard className="p-8 rounded-3xl bg-[#0A0A0A] border border-white/[0.04] flex flex-col justify-between h-full hover:border-white/[0.12] transition-colors duration-500">
              ...
              <p className="text-[#888888] font-light text-sm leading-relaxed mb-4">
                Evaluated architecture and engineering at major events including Diversion 2025 & 2026, Binary 2025 & 2026, and Rebase 01. Focused on guiding emerging talent toward scalable and resilient design.
              </p>
          ...
          >
            <GlowingCard className="p-8 rounded-3xl bg-[#0A0A0A] border border-white/[0.04] flex flex-col justify-between h-full hover:border-white/[0.12] transition-colors duration-500">
              ...
              <p className="text-[#888888] font-light text-sm leading-relaxed mb-4">
                Dedicated over 3 years to actively mentoring developers and early-career engineers. Fostering the next generation of global tech talent by instilling pragmatism and strong foundational systems knowledge.
              </p>
          ...
          >
            <GlowingCard className="p-8 rounded-3xl bg-[#0A0A0A] border border-white/[0.04] flex flex-col justify-between h-full hover:border-white/[0.12] transition-colors duration-500">
              ...
              <p className="text-[#888888] font-light text-sm leading-relaxed mb-4">
                Delivered 25+ technical talks globally, including DevFest Ahlen (Germany) and Flutter India Roadshow 2024. Open to international speaking engagements, tech talent programs, and government-sponsored summits.
              </p>

                    ...
                    <div className="md:col-start-2 flex flex-col justify-between">
                        <div>
                            ...
                            <ul className="flex gap-6 font-mono text-sm">
                                <li>
                                    <a href="https://linkedin.com/in/supratimdhara/" target="_blank" className="group block text-gray-400 hover:text-[#5FF2D6] transition-colors" aria-label="LinkedIn">
                                ...
                                <li>
                                    <a href="https://github.com/supratim1609" target="_blank" className="group block text-gray-400 hover:text-[#5FF2D6] transition-colors" aria-label="GitHub">
                                        <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li>
                                    <a href="https://medium.com/@supratimdhara0" target="_blank" className="group block text-gray-400 hover:text-[#5FF2D6] transition-colors" aria-label="Medium">
                                        <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li>
                                    <a href="https://www.instagram.com/dhara_apk/" target="_blank" className="group block text-gray-400 hover:text-[#5FF2D6] transition-colors" aria-label="Instagram">
                                        <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

...
export default function FlockMathPage() {
  return (
    <div className="min-h-screen bg-[#050505] text-[#E5E5E5] font-sans selection:bg-[#FF3B30] selection:text-white pb-32">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-32 pb-16 space-y-8 border-b border-white/5">
        <Link href="/flock-ml" className="flex items-center space-x-2 text-[#A1A1A1] hover:text-white transition-colors text-sm font-mono w-fit">
          <ArrowLeft size={16} />
          <span>Back to FlockML</span>
        </Link>
        <div className="space-y-4">
          <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-white leading-none">
            The Mathematics of FlockML
          </h1>
      ...
      <div className="max-w-4xl mx-auto px-6 pt-16 space-y-24">
        ...
        <section className="space-y-6">
          ...
          <div className="prose prose-invert max-w-none text-[#A1A1A1] text-lg leading-relaxed space-y-6">
            <p>
              The fundamental flaw of centralized AI is data extraction. To ensure that a user&apos;s raw browser data can never be reverse-engineered from their transmitted gradients, FlockML injects cryptographic noise into the matrix <em>before</em> it is quantized.
            </p>
            <p>
